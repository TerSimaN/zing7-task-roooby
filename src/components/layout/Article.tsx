...
const Article = ({ label = '', imgSrc = '', imgAlt = '', header = '', textSize = '', lineHeight = '', letterSpacing = '', date = '', author = '' }) => {
  return (
    <article className="flex flex-col max-w-[34.75rem]">
        ...
        <Image
            ...
            className="mt-6"
        />
        <h1 className={`font-inter font-bold text-[${textSize}] leading-[${lineHeight}] tracking-[${letterSpacing}] mt-4`}>{header}</h1>

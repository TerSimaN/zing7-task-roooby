...
const FAQs = () => {
    ...
    return (
        <div className="flex flex-col container sm:px-8 xl:px-0 px-4 xl:my-[7.5rem] my-[4.5rem]">
            <h1 className="font-inter font-bold xl:text-[4rem] text-5xl sm:leading-[4.5rem] tracking-[-0.89px] max-sm:text-center max-w-[37.25rem]">Frequently asked questions</h1>
